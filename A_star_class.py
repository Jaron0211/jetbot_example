...
#                 cv2.imshow("A* Test", img_)
    ...
    def decide_direction(self, p_0, p_1, att):
        ...
        elif p_1[0] > p_0[0] and att == down:  # head for right && toward downward
            planning = True
            direction = 'left'
            print('att: ', att)      
        
        elif p_1[1] < p_0[1] and att == right: # head for downward && toward right
            planning = True
            direction = 'right'
            print('att: ', att)       
            

        elif p_1[1] < p_0[1] and att == down:  # head for downward && toward downward
            direction = 'straight'
            planning = True
            print('att: ', att)
